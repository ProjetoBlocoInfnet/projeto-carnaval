...
public class FiltroDeAcesso implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response,
	    ...
	    if(usuario == null && "/CadastroTorcedor.jsp".equals(resource)){ //Necess�rio para que o torcedor possa fazer seu cadastro
        ...
        }else if(usuario == null && "/ControlaTorcedor".equals(resource)){ //Necess�rio para que o torcedor possa fazer seu cadastro
        	System.out.println("Possível torcedor acessando a URI "  + req.getRequestURI());
